...
const styles = StyleSheet.create({
  ...
  label: { color: colors.muted, fontSize: 12, letterSpacing: 0.5, textTransform: "uppercase" },
  value: { color: colors.text, fontSize: 25, fontWeight: "700" },
  action: { borderColor: colors.border, borderWidth: 1, borderRadius: 12, paddingHorizontal: 12, paddingVertical: 9, backgroundColor: colors.elevated },
